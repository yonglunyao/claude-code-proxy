...
# 默认字体：鸿蒙黑体 HarmonyHeiTi (路径: /usr/share/fonts/HarmonyFont)
FONT_PAIRS = {
    "authoritative": {
        "display_css":  "HarmonyHeiTi",
        "body_css":     "HarmonyHeiTi",
        "gfonts_import": "",
        "display_rl":   "HarmonyHeiTi-Bold",
        "body_rl":      "HarmonyHeiTi",
        "body_b_rl":    "HarmonyHeiTi-Bold",
    },
    "confident": {
        "display_css":  "HarmonyHeiTi",
        "body_css":     "HarmonyHeiTi",
    ...
    "chinese": {
        # CSS names for cover HTML (本地字体)
        "display_css":  "HarmonyHeiTi",
        "body_css":     "HarmonyHeiTi",
        "gfonts_import": "",  # 不使用 Google Fonts

        # ReportLab font names for body pages
        "display_rl":   "HarmonyHeiTi-Bold",
        "body_rl":      "HarmonyHeiTi",
        "body_b_rl":    "HarmonyHeiTi-Bold",
    },
